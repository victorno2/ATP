...
public:
     ...
     * */
	void grad_zero(cublasHandle_t *handle, 
					tensor_t<value_type> *weight_grad, 
					tensor_t<value_type> *bias_grad, 
					bool enable_bias);
